    ...
    try {
        ...
        <div id="pj-container">
            ...
            <footer id="pj-footer">
                ...
                <p>Esse orçamento é baseado nos dados fornecidos pelo contratante. Alterações encontradas "in loco" deverão passar por análise e revisão deste orçamento.</p>
            </footer>
        </div>
        `;
