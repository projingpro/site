            ...
            <div class="card client-category">
                ...
                ${orcamentosPorCliente[clienteId].map(o => `
                    <div class="client-item" onclick="showOrcamentoDetails('${o.id}')">
                        ...
                        <strong>Valor:</strong> R$ ${parseFloat(o.valorFinal).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} |
        ...
        <div id="pj-container">
            <header id="pj-header">
                ...
                <div id="pj-sub-header">
                    <div>Cliente:${client.nomeEmpresa}</div>
            ...
            <section class="pj-section">
                <h2>Total</h2>
                <p class="pj-highlight">R$ ${parseFloat(o.valorFinal).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
            </section>
